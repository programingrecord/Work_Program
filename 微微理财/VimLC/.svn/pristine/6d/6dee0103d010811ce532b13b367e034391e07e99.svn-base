...
#define kPAProgressView_ShowAnimateWithDuration 0.5f  //动画持续时间

#define kPAProgressView_AnimateDuration         1.2f  //显示时间
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    {
        // Initialization code
        [self setFrame:CGRectMake(0, 0, kDeviceWidth, kDeviceHeight)];
        [self setBackgroundColor:[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0]];
        
        m_pRectangleView = [[UIView alloc] initWithFrame:CGRectMake((kDeviceWidth-180)/2, kDeviceHeight * 0.5f, 180, 45)];
...
- (void)refreshFrameWithString:(NSString *)contentString type:(PAProgressViewType)type showView:(UIView*)view
{
    ...
    switch(type)
    {
        case PAProgressViewTypeString:
        {
            ...
            {
                [m_pRectangleView setFrame:CGRectMake(kDeviceWidth/2-90,
                                                      viewHeight*0.5-45*0.5,                                                   180,
                                                      45)];
            ...
            else
            {
                ...
                NSInteger nX = (kDeviceWidth - nWidth) * 0.5f;
                [m_pRectangleView setFrame:CGRectMake(nX,
                                                      viewHeight*0.5-45*0.5,
                                                      nWidth,
                                                      45)];
        ...
        case PAProgressViewTypeActivityIndicatorViewAndString:
        {
            ...
            else
            {
                ...
                NSInteger nRectangleView_X = (kDeviceWidth - nWidth) * 0.5f;
