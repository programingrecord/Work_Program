...
//NSString *const kInitVector = @"1234567812345678";

size_t const kKeySize = kCCKeySizeAES128;

@implementation MSUAesTools
...

{
    ...
    NSData *result = [MSUAesTools AES256ParmEncryptWithKey:key Encrypttext:data];
...

{
    ...
    NSData* result = [MSUAesTools  AES256ParmDecryptWithKey:key Decrypttext:data];
