...
@interface MSUTestSevenController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MSUTestSevenController
...
- (void)viewDidLoad {
    ...
    self.dataArr = @[@"A.除银行储蓄外，基本没有其他投资经验",@"B.购买过债券，理赔等投资产品",@"C.参与过股票、基金等产品的交易",@"D.参与过权证、期货、期权等产品的交易"];
...
- (void)createCenterUI{
    ...
    titLab.attributedText = [MSUStringTools makeKeyWordAttributedWithSubText:@"/13" inOrigiText:@"7/13" font:12 color:HEXCOLOR(0xFFDCD2)];
    [self.view addSubview:titLab];
    
    UILabel *quesLab = [[UILabel alloc] init];
    quesLab.text = @"您的投资经验可描述为：";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MSUTestEightController *second = [[MSUTestEightController alloc] init];
