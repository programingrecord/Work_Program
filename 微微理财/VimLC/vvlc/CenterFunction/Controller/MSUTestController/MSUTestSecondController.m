...
@interface MSUTestSecondController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MSUTestSecondController
...
- (void)viewDidLoad {
    ...
    self.dataArr = @[@"A.高中及以下",@"B.中专或大专",@"C.本科",@"D.硕士及以上"];
...
- (void)createCenterUI{
    ...
    titLab.attributedText = [MSUStringTools makeKeyWordAttributedWithSubText:@"/13" inOrigiText:@"2/13" font:12 color:HEXCOLOR(0xFFDCD2)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MSUTestThirdController *second = [[MSUTestThirdController alloc] init];
