...
@interface MSUTestNineController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MSUTestNineController
...
- (void)viewDidLoad {
    ...
    self.dataArr = @[@"A.活期，随存随取",@"B.1个月以下",@"C.1月-3月",@"D.3月以上"];
...
- (void)createCenterUI{
    ...
    titLab.attributedText = [MSUStringTools makeKeyWordAttributedWithSubText:@"/13" inOrigiText:@"9/13" font:12 color:HEXCOLOR(0xFFDCD2)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MSUTestTenController *second = [[MSUTestTenController alloc] init];
